...
class ReflectiveAdapterTest {
    ...
    class NamingStrategyTests {
        ...
        void lowerUnderscoreStrategy() {
            Dobby snakeDobby = Dobby.builder()
    ...
    public static class Product {
        @SolrField("id") public String id;
        @SolrField("name") public String name;
        @SolrField("price") public double price;
    }
    ...
    public static class StatusBean {
        @SolrField("id") public String id;
        @SolrField("status") public Status status;
    }

    public static class TimestampBean {
        @SolrField("id") public String id;
        @SolrField("created_at") public Instant createdAt;
    }

    public static class TaggedBean {
        @SolrField("id") public String id;
        @SolrField("tags") public List<String> tags;
    }

    public static class OptionalBean {
        @SolrField("id") public String id;
        @SolrField("description") public Optional<String> description;
    }
    ...
    public static class ExtendedBean extends BaseBean {
        @SolrField("extra") public String extra;
    }
    ...
    public static class Variant {
        @SolrField("sku") public String sku;
        @SolrField("color") public String color;
    }

    public static class ProductWithVariants {
        @SolrField("id") public String id;
        @SolrField("name") public String name;
        @SolrField(value = "variants", nested = true) public List<Variant> variants;
    }

    public static class ProductWithSingleVariant {
        @SolrField("id") public String id;
        @SolrField(value = "primary_variant", nested = true) public Variant primaryVariant;
    }

    public static class DynamicBean {
        @SolrField("id") public String id;
        @SolrField("attributes") public Map<String, Object> attributes;
    }
    ...
    public static class ExplicitNameBean {
        @SolrField("custom_id") public String myId;
    }

    public static class ProductWithArrayVariants {
        @SolrField("id") public String id;
        @SolrField(value = "variants", nested = true) public Variant[] variants;
    }
    ...
    public static class ProductWithVariantsNoFlag {
        ...
        @SolrField("variants_no_flag") public List<Variant> variantsNoFlag;
    }
    ...
    public static class ItemWithCategories {
        @SolrField("id") public String id;
        @SolrField("cat") public String[] categories;
    }

    public static class MixedListBean {
        @SolrField("id") public String id;
        @SolrField("tags") public List<String> tags;
        @SolrField(value = "nested_items", nested = true) public List<Variant> nestedItems;
    }
}
