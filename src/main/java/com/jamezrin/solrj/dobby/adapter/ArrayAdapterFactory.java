...
/**
 * Factory for adapters that handle array types ({@code T[]}). Delegates to the component-type
 * adapter for each element.
 *
 * <p>Does <b>not</b> handle {@code byte[]} - that is covered by {@link PrimitiveAdapterFactory}.
 */
