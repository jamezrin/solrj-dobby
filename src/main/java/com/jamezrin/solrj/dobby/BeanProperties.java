 ...
 *
 * <p>
 * Replaces manual "get" + capitalize / "is" + capitalize logic with
 * the standard {@code java.beans} API, which correctly handles all
...
public final class BeanProperties {
     ...
     *
     * <p>
     * Uses {@link Introspector#getBeanInfo(Class, Class)} with stop class
     * {@code Object.class} to exclude the {@code getClass()} pseudo-property.
     *
     ...
     *
     * <p>
     * Uses {@link Introspector#decapitalize} for correct handling of
     * edge cases (e.g., "setURL" → "URL", not "uRL").
     *
