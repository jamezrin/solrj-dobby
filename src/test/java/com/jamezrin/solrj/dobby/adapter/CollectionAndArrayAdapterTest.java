...
class CollectionAndArrayAdapterTest {
    ...
    class MapAdapterTests {
        ...
        void readsMapOfStringToString() {
            TypeAdapter<Map<String, String>> adapter = dobby.getAdapter(new TypeToken<Map<String, String>>() {});
        ...
        @Test
        void writesMap() {
            TypeAdapter<Map<String, Integer>> adapter = dobby.getAdapter(new TypeToken<Map<String, Integer>>() {});
    ...
    class OptionalAdapterTests {
        ...
        void readsNullAsEmpty() {
            TypeAdapter<Optional<String>> adapter = dobby.getAdapter(new TypeToken<Optional<String>>() {});
