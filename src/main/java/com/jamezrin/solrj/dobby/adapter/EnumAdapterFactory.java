...
/**
 * Factory for adapters that handle {@link Enum} types.
 * Converts between enum constants and their {@link Enum#name()} strings.
 */
            ...
            if (solrValue instanceof String s) {
                try {
                    ...
                    throw new DobbyException(
                            "No enum constant " + enumClass.getName() + "." + s, e);
                }
            }
            // Try ordinal
