...
/**
 * Factory for adapters that handle Java primitive types, their wrappers, {@code String}, {@code
 * byte[]}, and {@code ByteBuffer}.
 *
 * <p>Solr already returns most of these types natively, so these adapters mainly perform type
 * coercion (e.g. Solr returns {@code Long} but your field is {@code Integer}).
 */
public final class PrimitiveAdapterFactory implements TypeAdapterFactory {
  ...
  /**
   * Pass-through adapter for {@code Object.class}. Used when the value type is not known at compile
   * time (e.g. {@code Map<String, Object>}). Returns values as-is without any conversion.
   */
  private static final TypeAdapter<Object> OBJECT_ADAPTER =
  ...
  private static final TypeAdapter<Integer> INT_ADAPTER =
      new TypeAdapter<Integer>() {
        ...
        public Integer read(Object solrValue) {
          ...
          throw new DobbyException(
              "Cannot convert " + solrValue.getClass().getName() + " to Integer");
        }
  ...
  private static final TypeAdapter<Long> LONG_ADAPTER =
  ...
  private static final TypeAdapter<Float> FLOAT_ADAPTER =
      new TypeAdapter<Float>() {
        @Override
        public Float read(Object solrValue) {
          ...
          throw new DobbyException(
              "Cannot convert " + solrValue.getClass().getName() + " to Float");
        }
  ...
  private static final TypeAdapter<Double> DOUBLE_ADAPTER =
      new TypeAdapter<Double>() {
        ...
        public Double read(Object solrValue) {
          ...
          throw new DobbyException(
              "Cannot convert " + solrValue.getClass().getName() + " to Double");
        }
  ...
  private static final TypeAdapter<Boolean> BOOLEAN_ADAPTER =
      new TypeAdapter<Boolean>() {
        ...
        public Boolean read(Object solrValue) {
          ...
          throw new DobbyException(
              "Cannot convert " + solrValue.getClass().getName() + " to Boolean");
        }
  ...
  private static final TypeAdapter<Byte> BYTE_ADAPTER =
  ...
  private static final TypeAdapter<Short> SHORT_ADAPTER =
      new TypeAdapter<Short>() {
        @Override
        public Short read(Object solrValue) {
          ...
          throw new DobbyException(
              "Cannot convert " + solrValue.getClass().getName() + " to Short");
        }
  ...
  private static final TypeAdapter<byte[]> BYTE_ARRAY_ADAPTER =
      new TypeAdapter<byte[]>() {
        @Override
        public byte[] read(Object solrValue) {
          if (solrValue == null) return null;
          ...
          throw new DobbyException(
              "Cannot convert " + solrValue.getClass().getName() + " to byte[]");
        }
  ...
  private static final TypeAdapter<ByteBuffer> BYTE_BUFFER_ADAPTER =
      new TypeAdapter<ByteBuffer>() {
        @Override
        public ByteBuffer read(Object solrValue) {
          ...
          throw new DobbyException(
              "Cannot convert " + solrValue.getClass().getName() + " to ByteBuffer");
        }
