...
class DobbyTest {
  ...
  void customAdapterOverridesBuiltIn() {
    TypeAdapter<String> uppercaseAdapter =
        new TypeAdapter<>() {
          @Override
    ...
    Dobby dobby = Dobby.builder().registerAdapter(String.class, uppercaseAdapter).build();
  ...
  void fieldNamingStrategyApplied() {
    Dobby dobby = Dobby.builder().fieldNamingStrategy(FieldNamingStrategy.LOWER_UNDERSCORE).build();
