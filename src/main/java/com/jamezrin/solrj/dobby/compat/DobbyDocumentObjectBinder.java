 ...
 *
 * <p>This allows drop-in replacement of SolrJ's DocumentObjectBinder with Dobby's
 * enhanced capabilities (records, java.time, enums, custom adapters, etc.) without
 * changing existing code that depends on the DocumentObjectBinder API.
 *
 * <p>Example migration:
 * <pre>{@code
 * // Before:
 ...
 * }</pre>
 *
 * <p>For more control over the Dobby configuration, use the constructor that accepts
 * a {@link Dobby} instance:
 * <pre>{@code
