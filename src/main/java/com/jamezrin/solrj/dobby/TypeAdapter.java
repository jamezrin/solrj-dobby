 ...
 *
 * <p>For <b>simple types</b> (String, Integer, Enum, Instant, etc.), {@link #read(Object)} receives
 * the raw Solr field value and {@link #write(Object)} returns a raw value suitable for {@link
 * org.apache.solr.common.SolrInputDocument#setField}.
 *
 * <p>For <b>bean/record types</b>, {@link #read(Object)} receives a {@link
 * org.apache.solr.common.SolrDocument} and {@link #write(Object)} returns a {@link
 * org.apache.solr.common.SolrInputDocument}. This uniformity is what makes the adapter chain
 * composable - a {@code ListTypeAdapter} wraps an element adapter, a reflective adapter delegates
 * to per-field adapters, etc.
 *
...
public abstract class TypeAdapter<T> {
   ...
   * @return the Solr-compatible value (raw field value or {@code SolrInputDocument}), or {@code
   *     null} if the input is {@code null}
   */
  public abstract Object write(T value);

  /**
   * Returns a null-safe wrapper around this adapter. The returned adapter passes through {@code
   * null} without delegating.
   */
