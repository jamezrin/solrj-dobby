...
class SolrJCompatAdapterTest {
    ...
    /**
     * When both @SolrField and @Field are present, @SolrField wins
     * because ReflectiveAdapterFactory runs before SolrJCompatAdapterFactory.
     */
    ...
    /**
     * Parent with @Field-annotated child list but WITHOUT child=true.
     * Modern Solr can return List<SolrDocument> as a field value.
     */
