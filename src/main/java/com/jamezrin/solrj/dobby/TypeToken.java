...
public class TypeToken<T> {
    ...
    private static Type getSuperclassTypeParameter(Class<?> subclass) {
        ...
        if (superclass instanceof Class) {
            throw new IllegalArgumentException("TypeToken must be created with a type parameter: new TypeToken<T>() {}");
        }
    ...
    public static Class<?> getRawType(Type type) {
        ...
        if (type instanceof Class<?> cls) {
            ...
            throw new IllegalArgumentException("Expected a Class, ParameterizedType, GenericArrayType, or WildcardType, but got: " + type.getClass().getName());
        }
    }
