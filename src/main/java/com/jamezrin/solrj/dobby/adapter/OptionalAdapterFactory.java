 ...
 *
 * <p>Reading: a {@code null} Solr value becomes {@code Optional.empty()}; otherwise the inner
 * adapter is used and wrapped in {@code Optional.of()}.
 *
 * <p>Writing: {@code Optional.empty()} becomes {@code null}; otherwise the inner value is written
 * via the inner adapter.
 */
